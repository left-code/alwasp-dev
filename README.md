...
For example, tool version `0.2.1` corresponds to documentation package version `0.2.1` and git
tag `v0.2.1`. Matching tags keep documentation history aligned with the exact CLI and schema it
