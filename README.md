...
For example, tool version `0.2.0` corresponds to documentation package version `0.2.0` and git
tag `v0.2.0`. Matching tags keep documentation history aligned with the exact CLI and schema it
describes and give the next release a clear comparison baseline.
